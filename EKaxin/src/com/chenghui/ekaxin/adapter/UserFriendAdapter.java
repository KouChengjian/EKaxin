...
public class UserFriendAdapter extends BaseAdapter implements SectionIndexer{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(ct).inflate(R.layout.item_carte_list, null);
			...
			viewHolder.duty = (TextView) convertView.findViewById(R.id.tv_friend_duty);
		...
		viewHolder.name.setText(friend.getUserChainName());*/
		viewHolder.name.setText(friend.getUsername());
		/**
		 *  公司
		 
		viewHolder.duty.setText(friend.getUserCompany());*/
		viewHolder.duty.setVisibility(View.GONE);
