...
public class EditNameActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initTopBarForLeft("用户名");
		input = (EditText) findViewById(R.id.name_comment_content);
		commit = (Button) findViewById(R.id.name_comment_commit);
